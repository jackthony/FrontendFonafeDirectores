...
import { CONFIG_ACTIVE_DIALOG_SPECIALTY, CONFIG_INACTIVE_DIALOG_SPECIALTY, MAINTENANCE_SPECIALTY_HEADER_TABLE } from 'app/modules/system-maintenance/config/maintenance-specialty.config';
