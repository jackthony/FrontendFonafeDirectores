...
import { CONFIG_ACTIVE_DIALOG_ROLE, CONFIG_INACTIVE_DIALOG_ROLE, MAINTENANCE_ROL_HEADER_TABLE } from 'app/modules/system-maintenance/config/maintenance-role.config';
...
import { ModuleService } from 'app/modules/system-maintenance/domain/services/module.service';
