...
import { CONFIG_ACTIVE_DIALOG_INDUSTRY, CONFIG_INACTIVE_DIALOG_INDUSTRY, MAINTENANCE_INDUSTRY_HEADER_TABLE } from 'app/modules/system-maintenance/config/maintenance-industry.config';
