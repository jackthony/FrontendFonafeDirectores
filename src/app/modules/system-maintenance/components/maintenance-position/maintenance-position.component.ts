...
import { CONFIG_ACTIVE_DIALOG_POSITION, CONFIG_INACTIVE_DIALOG_POSITION, MAINTENANCE_POSITION_HEADER_TABLE } from 'app/modules/system-maintenance/config/maintenance-position.config';
