...
import { ConstantService } from 'app/modules/system-maintenance/domain/services/constant.service';
import { ConstantEntity } from '../entities/constant.entity';
import { DepartmentEntity } from '../entities/departament.entity';
import { UbigeoService } from './ubigeo.service';
import { TypeDirectorEntity } from 'app/modules/system-maintenance/domain/entities/type-director.entity';
import { TypeDirectorService } from 'app/modules/system-maintenance/domain/services/type-director.service';
import { SpecialtyEntity } from 'app/modules/system-maintenance/domain/entities/specialty.entity';
import { SpecialtyService } from 'app/modules/system-maintenance/domain/services/specialty.service';
import { SectorEntity } from 'app/modules/system-maintenance/domain/entities/sector.entity';
import { SectorService } from 'app/modules/system-maintenance/domain/services/sector.service';
import { ResponseEntity } from '@models/response.entity';
import { CONST_CARGO_DIRECTOR, CONST_GENDER, CONST_TYPE_DOCUMENT } from '../../config/directory-business.config';
