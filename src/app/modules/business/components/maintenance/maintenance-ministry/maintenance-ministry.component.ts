...
import { CONFIG_ACTIVE_DIALOG_MINISTRY, CONFIG_INACTIVE_DIALOG_MINISTRY, MAINTENANCE_MINISTRY_MANAGEMENT } from 'app/modules/business/config/maintenance/maintenance-ministry.config';
