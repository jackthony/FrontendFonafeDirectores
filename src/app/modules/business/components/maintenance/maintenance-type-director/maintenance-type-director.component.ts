...
import { CONFIG_ACTIVE_DIALOG_TYPE_DIRECTOR, CONFIG_INACTIVE_DIALOG_TYPE_DIRECTOR, MAINTENANCE_TYPE_DIRECTOR_HEADER_TABLE } from 'app/modules/business/config/maintenance/maintenance-type-director.config';
