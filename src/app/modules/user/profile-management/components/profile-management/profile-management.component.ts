...
import { PositionService } from 'app/modules/system-maintenance/domain/services/position.service';
...
import { COLUMNS_PROFILE_MANAGEMENT, CONST_STATUS_USER, CONST_TYPE_PERSONAL } from '../../config/profile-management.config';
